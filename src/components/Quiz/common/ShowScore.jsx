...
import { getSystemSettings, getUserData } from "../../../utils";
    ...
    return (
        <React.Fragment>
            <div className="score-section  text-center bold">
                {percentage >= sysSettings.maximum_coins_winning_percentage ? (
                    <>
                        <h4 className="winlos">
                            <b>{t("Winner")}</b>
                        </h4>
                                ...
                                return (
                                    <CircularProgressbarWithChildren
                                        ...
                                        styles={buildStyles({
                                            ...
                                            pathColor: percentage >= sysSettings.maximum_coins_winning_percentage ? "#15ad5a" : "#ef5488",
                                        })}
                                    >
                                        <img src={user && user.profile ? user.profile : process.env.PUBLIC_URL + "/images/user.webp"} alt="user" className="showscore-userprofile" onError={imgError}/>
                                    </CircularProgressbarWithChildren>
                                );
                            }}
            ...
            <div className="dashoptions row text-center">
                {percentage >= sysSettings.maximum_coins_winning_percentage && maxLevel !== String(currentLevel) ? (
                    nextlevel ? (
