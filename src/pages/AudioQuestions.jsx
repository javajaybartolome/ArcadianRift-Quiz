...
const AudioQuestions = ({ t }) => {
    ...
    const getAllData = () => {
        ...
        api.getCategories(4).then((response) => {
    ...
    const handleChangeCategory = async (data) => {
        ...
        } else if(data.no_of_que === "0" && data.no_of === "0"){
            toast.error(t("No Data found"));
        } else {
            history.push({
                pathname: "/AudioQuetionsPlay",
                data: {
                    category_id: data.id,
                },
            });
                    ...
                    <div className="row morphisam mb-5">
                        ...
                        <div className="col-xxl-9 col-xl-8 col-lg-8 col-md-12 col-12">
                            <div className="right-sec">
                                <AudioQuestionsSlider data={subCategory} url={`/AudioQuestionsPlay`} Questionsloader={subloading} />
                            </div>
                        </div>
                    </div>
                </div>
